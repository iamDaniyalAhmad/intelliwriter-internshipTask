...
const Home = () => {
    const heroContent = {
        title : 'IntelliWriter Free Platform For AI Image Generator',
        ...
        btntext : "Try Intelliwriter AI Image Generator For Free !"
    }
    const headingContent = {
        title : "HOW CONTENT",
        title2 : "GENERATES",
        desc : "Embark on an unstoppable journey of creativity with our AI Image Generator – where your text come to life with captivating AI images in just a few clicks!",
    }
    ...
    const obj = [
        ...
        {
            img : 'images/imageStep2.webp',
            title : 'Step#2',
            desc : "Enter Prompt to Search: Within the AI Image Generator, you'll find a blank canvas eagerly awaiting your inspiration. Guide the AI with your words and watch your ideas transform into art."
        },
        {
            img : 'images/imageStep3.webp',
            title : 'Step#3',
            desc : 'Wait For the Response: Creativity takes time, even for AI. Sit back, relax, and let the magic unfold.'
        },
        {
            img : 'images/imageStep4.webp',
            title : 'Step#4',
            desc : 'Get ready to be amazed – your content is ready.'
        },
    ]
    const Aitools =[
        {
    ...
    const question = [
        {
          index: 1,
          q:"How Does Your Image Generator Work?",
          a: "Our Image Generator harnesses the power of advanced AI algorithms. It allows you to effortlessly create captivating images with dynamic prompts and innovative tools. Whether you're a designer, blogger, or project enthusiast, our tool empowers you to craft visually stunning content within seconds.,"
        },
        {
          index: 2,
          q: "Can I Customize the Style and Elements of the Generated Images?",
          a: "Absolutely! Our Image Generator is designed for flexibility. You can customize the style, color schemes, and elements of the generated images. It's a versatile tool that adapts to your creative vision and branding requirements.",
        },
        {
          index: 3,
          q : "What Types of Projects Can Benefit from the Image Generator?",
          a : "Our Image Generator is ideal for a wide range of projects. Whether you're working on blog posts, social media content, presentations, or any creative endeavor, this tool provides the dynamic features you need to enhance your visual storytelling."
        },
        {
            index:4,
            q: "Is the Generated Image Content Royalty-Free?",
            a: "Yes! You retain full rights to the images generated by our tool. We do not claim any royalties or ownership over the content you create. It's your creative work, and you have the freedom to use it as you see fit.",
        },
        {
            index : 5,
            q: "How Can Your Image Generator Boost Creativity in Design Projects?",
            a: "Immerse yourself in a realm of creative exploration with our AI-powered Image Generator. It provides a variety of prompts and tools that nurture artistic expression. Whether you're a seasoned designer or a beginner, this tool empowers you to create captivating visuals effortlessly."
        }
  ...
  return (
    ...
    <Start title="Start generating your AI Image now for free"/>
    </div>
    </>
  )
}
